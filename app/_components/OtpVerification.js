...
function onOTPVerify() {
    ...
    <section className="bg-violet-600 flex items-center justify-center h-screen">
      <div>
       ...
       <Toaster  toastOptions={{duration: 4000}}/>
        ...
        {
          user ? (
            <h2 className='text-center text-white font-medium text-2xl mb-6'>👍 Login Success </h2>
          ) : (
 ...
 
 {
   ...
   >
    ...
    <button onClick={onOTPVerify} className="bg-violet-800 w-full flex gap-1 items-center justify-center py-2.5 text-white rounded">
     {
       loading &&   <CgSpinner size={20} className="mt-2 animate-spin"/>
     }
